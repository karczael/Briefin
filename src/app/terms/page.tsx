      ...
      <article className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="mt-10 space-y-10 text-[15px] leading-relaxed text-[hsl(var(--foreground))]/90">
          ...
          <Section title="제5조 (서비스의 내용)">
            <ol className="list-decimal pl-5 space-y-2">
              <li><strong>Free 등급</strong>: 브리핑 요약, 토론방 시청, 리서치 제목, 기본 시황</li>
              <li><strong>Premium 등급</strong> (월 14,900원): 전체 브리핑, 개인화 브리핑, 리서치 전문, 토론 상세, 밸류에이션 차트, 팟캐스트</li>
              <li><strong>VIP 등급</strong> (월 29,900원): Premium 전체 + 전략 설정, 매매 신호 알림, 토론 참여, 자동 손절 서비스</li>
